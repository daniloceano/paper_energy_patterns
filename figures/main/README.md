...
### Figure 7: EP1 vs EP2 Dynamical Composites (3×2)
**File:** `7_ep1_ep2_dynamical_composites.png`
...
- **Number of shading levels:** 21 (np.linspace, symmetric).
...
Outputs:
- `figures/main/7_ep1_ep2_dynamical_composites.png` (300 DPI)
...
**Purpose**: Documents the case selection methodology and shows spatial distribution of selected EP1 cyclones used for instability diagnostics.
...
- Justifies pressure level selection for instability composites
...
**Purpose**: Identifies critical pressure levels for instability diagnostics and justifies the vertical level selection used in composite analysis.
