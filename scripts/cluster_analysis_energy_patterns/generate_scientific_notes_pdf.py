...
Output:
  docs/scientific_notes_cluster_analysis.pdf
...
SCRIPT_DIR = PROJECT_ROOT / "scripts" / "cluster_analysis_energy_patterns"
DOCS_DIR = PROJECT_ROOT / "docs"
DOCS_DIR.mkdir(parents=True, exist_ok=True)

SCIENTIFIC_NOTES_MD = SCRIPT_DIR / "SCIENTIFIC_NOTES.md"
OUTPUT_PDF = DOCS_DIR / "scientific_notes_cluster_analysis.pdf"
...
def main():
    print("=" * 70)
    print("CLUSTER ANALYSIS SCIENTIFIC NOTES → PDF CONVERTER")
    print("=" * 70)
