...
Map showing the subset of EP1 cyclones selected for detailed instability diagnostics (Rayleigh–Kuo criterion, Potential Vorticity, Eady Growth Rate).

#### Selection Criteria

**Energy Pattern**: EP1 (cluster 0) only

**Lifecycle**: Complete development sequence required
- Incipient → Intensification → Mature → Decay (no missing phases)

**Spatial Constraint**: Intensification center within selection domain
- **Domain**: 60°W–45°W, 45°S–30°S
- **Intensification center**: Actual track point closest to temporal midpoint of intensification phase
- **Rationale**: Ensures environmental homogeneity for meaningful comparison of instability diagnostics
