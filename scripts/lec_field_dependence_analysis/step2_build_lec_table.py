...
This table is the "X" side of the PREDEP analysis.

Output:
  results/lec_field_dependence/step2_lec_intensification_means.csv
...
def main():
    ...
    logging.info(f"\nLoading LEC intensification means (workers={N_WORKERS})...")
    results = {}
    failed = []
